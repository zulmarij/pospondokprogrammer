        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ ($category_name === 'user') ? 'active' : '' }}">
                <a href="#user" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'user') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'user') ? 'show' : '' }}" id="user"
                    data-parent="#accordionExample">
                    <li class="{{ ($page_name === 'index_user') ? 'active' : '' }}">
            ...
            <li class="menu {{ ($category_name === 'barang') ? 'active' : '' }}">
                <a href="#barang" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'barang') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'barang') ? 'show' : '' }}" id="barang"
                    data-parent="#accordionExample">
                    <li class="{{ ($page_name === 'index_barang') ? 'active' : '' }}">
                        <a href="/admin/barang"> Data Barang </a>
                    </li>
                </ul>
            </li>
            <li class="menu {{ ($category_name === 'kategori') ? 'active' : '' }}">
                <a href="#kategori" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'kategori') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'kategori') ? 'show' : '' }}"
                    id="kategori" data-parent="#accordionExample">
                    <li class="{{ ($page_name === 'index_kategori') ? 'active' : '' }}">
                        <a href="/admin/kategori"> Data Kategori </a>
                    </li>
                </ul>
            </li>
